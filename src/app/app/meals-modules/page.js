...
export default function MealsModulesPage() {
  const { data: modules, loading, error } = useGymList("meals-modules");
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-default-500">Meal components and sections.</p>
      <Card className="mt-6">
        {modules.length === 0 ? (
          <CardBody className="text-center py-12 text-default-500">No meals modules yet.</CardBody>
        ) : (
