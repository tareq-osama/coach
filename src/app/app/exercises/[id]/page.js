...
export default function ExerciseDetailPage() {
  ...
  useEffect(() => {
    if (doc) {
      setForm({
        ...
        muscle_group_id: doc.muscle_group_id ?? "",
  ...
  if (error || !doc) {
    return (
      <div>
        <Button as={Link} href="/app/exercises" variant="light" size="sm">
          ← Exercises
        </Button>
    ...
    <div>
      <div className="mb-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-semibold text-foreground">{doc.name || "Exercise"}</h1>
        </div>
        ...
        <CardBody className="gap-6">
          <form onSubmit={handleSave} className="flex flex-col gap-6">
            ...
            <div className="flex gap-2">
              ...
              <Button as={Link} href="/app/exercises" variant="flat">
                Cancel
              </Button>
            </div>
          </form>
