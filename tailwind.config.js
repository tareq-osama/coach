...
module.exports = {
  ...
  plugins: [
    heroui({
      themes: {
        /* Theme from docs/theme coloring example.md – light/dark default scale and semantics */
        light: {
          colors: {
            default: {
              50: "#fafafa",
        ...
        dark: {
          colors: {
            ...
            focus: "#00eb95",
            overlay: "#000000",
            /* Sidebar palette – base #000d21, tones for border/hover/text (used by app sidebar only) */
            sidebar: {
              50: "#000d21",
              100: "#0a1630",
              200: "#0f2847",
